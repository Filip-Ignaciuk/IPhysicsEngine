#ifndef IPHYSICS_PARTICLEFORCEGENERATOR_HPP
#define IPHYSICS_PARTICLEFORCEGENERATOR_HPP
#include <vector>
...
struct ParticleForceRegistration {
  ...
  bool operator==(const ParticleForceRegistration& other) const {
    return particle == other.particle &&
           particleForceGenerator == other.particleForceGenerator;
  }
};
...
class ParticleRealGravity : public ParticleForceGenerator {
 ...
 public:
  ParticleRealGravity(std::vector<ParticleForceRegistration>* registrations,
                      real gravitationalConstant);
  void UpdateForce(Particle* particle, real duration) override;
};
...
class ParticleAnchoredSpring : public ParticleForceGenerator {
 ...
 public:
  ParticleAnchoredSpring(Vector3 anchoredPosition, real springConsant,
                         real restLength);
  void UpdateForce(Particle* particle, real duration) override;
};
...
class ParticleAnchoredBungee : public ParticleForceGenerator {
 ...
 public:
  ParticleAnchoredBungee(Vector3 anchoredPosition, real springConsant,
                         real restLength);
  void UpdateForce(Particle* particle, real duration) override;
};
...
class ParticleFakeAnchoredSpring : public ParticleForceGenerator {
 ...
 public:
  ParticleFakeAnchoredSpring(Vector3 anchoredPosition, real springConstant,
                             real damping);
  void UpdateForce(Particle* particle, real duration) override;
};
