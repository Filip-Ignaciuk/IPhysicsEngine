...
IPhysics::Vector3::Vector3(real x, real y, real z)
    : x(x),
      y(y),
      z(z){
...
// Dot product
IPhysics::Vector3 IPhysics::Vector3::operator*(
    const IPhysics::real& magnitude) const {
...
// Queries
IPhysics::Vector3 IPhysics::Vector3::ComponentProduct(
    const Vector3& vector) const {
  return {x * vector.x, y * vector.y, z * vector.z};
}

IPhysics::Vector3 IPhysics::Vector3::VectorProduct(
    const Vector3& vector) const {
  return {y * vector.z - z * vector.y, z * vector.x - x * vector.z,
          x * vector.y - y * vector.x};
}
...
// Static
void IPhysics::Vector3::MakeOrthonormalBasis(Vector3* vectorA, Vector3* vectorB,
                                             Vector3* vectorC) {
  vectorA->Normalise();
...
IPhysics::Quaternion::Quaternion(real r, real i, real j, real k)
    : r(r), i(i), j(j), k(k) {}
...
void IPhysics::Quaternion::AddScaledVector(const Vector3& vector3, real scale) {
  Quaternion q{0, vector3.x * scale, vector3.y * scale, vector3.z * scale};
...
IPhysics::Matrix3::Matrix3(real a1, real a2, real a3, real b1, real b2, real b3,
...
IPhysics::Matrix3 IPhysics::Matrix3::operator*(const Matrix3& other) const {
  return {data[0] * other.data[0] + data[1] * other.data[3] +
              data[2] * other.data[6],
          data[0] * other.data[1] + data[1] * other.data[4] +
              data[2] * other.data[7],
          data[0] * other.data[2] + data[1] * other.data[5] +
              data[2] * other.data[8],
          data[3] * other.data[0] + data[4] * other.data[3] +
              data[5] * other.data[6],
          data[3] * other.data[1] + data[4] * other.data[4] +
              data[5] * other.data[7],
          data[3] * other.data[2] + data[4] * other.data[5] +
              data[5] * other.data[8],
          data[6] * other.data[0] + data[7] * other.data[3] +
              data[8] * other.data[6],
          data[6] * other.data[1] + data[7] * other.data[4] +
              data[8] * other.data[7],
          data[6] * other.data[2] + data[7] * other.data[5] +
              data[8] * other.data[8]};
}

void IPhysics::Matrix3::operator*=(const Matrix3& other) {
  real t1 = data[0] * other.data[0] + data[1] * other.data[3] +
            data[2] * other.data[6];
  real t2 = data[0] * other.data[1] + data[1] * other.data[4] +
            data[2] * other.data[7];
  real t3 = data[0] * other.data[2] + data[1] * other.data[5] +
            data[2] * other.data[8];
  data[0] = t1;
  data[1] = t2;
  data[2] = t3;
  t1 = data[3] * other.data[0] + data[4] * other.data[3] +
       data[5] * other.data[6];
  t2 = data[3] * other.data[1] + data[4] * other.data[4] +
       data[5] * other.data[7];
  t3 = data[3] * other.data[2] + data[4] * other.data[5] +
       data[5] * other.data[8];
  data[3] = t1;
  data[4] = t2;
  data[5] = t3;
  t1 = data[6] * other.data[0] + data[7] * other.data[3] +
       data[8] * other.data[6];
  t2 = data[6] * other.data[1] + data[7] * other.data[4] +
       data[8] * other.data[7];
  t3 = data[6] * other.data[2] + data[7] * other.data[5] +
       data[8] * other.data[8];
  data[6] = t1;
  data[7] = t2;
  data[8] = t3;
...
IPhysics::Vector3 IPhysics::Matrix3::operator*(const Vector3& vector3) const {
  return {vector3.x * data[0] + vector3.y * data[1] + vector3.z * data[2],
...
void IPhysics::Matrix3::SetInverse(const Matrix3& matrix) {
  ...
  const real det =
      (t1 * matrix.data[8] - t2 * matrix.data[7] - t3 * matrix.data[8] +
  ...
  data[0] =
      (matrix.data[4] * matrix.data[8] - matrix.data[5] * matrix.data[7]) *
      inverse;
  data[1] =
      -(matrix.data[1] * matrix.data[8] - matrix.data[2] * matrix.data[7]) *
      inverse;
  data[2] =
      (matrix.data[1] * matrix.data[5] - matrix.data[2] * matrix.data[4]) *
      inverse;
  data[3] =
      -(matrix.data[3] * matrix.data[8] - matrix.data[5] * matrix.data[6]) *
      inverse;
  data[4] = (matrix.data[0] * matrix.data[8] - t6) * inverse;
  data[5] = -(t2 - t4) * inverse;
  data[6] =
      (matrix.data[3] * matrix.data[7] - matrix.data[4] * matrix.data[6]) *
      inverse;
...
void IPhysics::Matrix3::SetOrientation(const Quaternion& quaternion) {
  data[0] =
      1 - (2 * quaternion.j * quaternion.j + 2 * quaternion.k * quaternion.k);
  ...
  data[4] =
      1 - (2 * quaternion.i * quaternion.i + 2 * quaternion.k * quaternion.k);
  ...
  data[8] =
      1 - (2 * quaternion.i * quaternion.i + 2 * quaternion.j * quaternion.j);
}

void IPhysics::Matrix3::SetComponents(const Vector3& componentOne,
                                      const Vector3& componentTwo,
                                      const Vector3& componentThree) {
...
void IPhysics::Matrix3::Invert() { SetInverse(*this); }
...
IPhysics::Vector3 IPhysics::Matrix3::TransformTranspose(
    const Vector3& vector3) const {
  return {vector3.x * data[0] + vector3.y * data[3] + vector3.z * data[6],
          vector3.x * data[1] + vector3.y * data[4] + vector3.z * data[7],
          vector3.x * data[2] + vector3.y * data[5] + vector3.z * data[8]};
}

// Static
IPhysics::Matrix3 IPhysics::Matrix3::LinearInterpolate(
    const Matrix3& startMatrix, const Matrix3& endMatrix, real proportion) {
  Matrix3 result;
...
IPhysics::Vector3 IPhysics::Matrix4::operator*(const Vector3& vector3) const {
  return {
      ...
      vector3.x * data[8] + vector3.y * data[9] + vector3.z * data[10] +
          data[11]};
}
...
void IPhysics::Matrix4::SetInverse(const Matrix4& matrix) {
  ...
  data[0] =
      (-matrix.data[9] * matrix.data[6] + matrix.data[5] * matrix.data[10]) *
      det;
  data[4] =
      (matrix.data[8] * matrix.data[6] - matrix.data[4] * matrix.data[10]) *
      det;
  data[8] = (-matrix.data[8] * matrix.data[5] +
             matrix.data[4] * matrix.data[9] * matrix.data[15]) *
            det;
  data[1] =
      (matrix.data[9] * matrix.data[2] - matrix.data[1] * matrix.data[10]) *
      det;
  data[5] =
      (-matrix.data[8] * matrix.data[2] + matrix.data[0] * matrix.data[10]) *
      det;
  data[9] = (matrix.data[8] * matrix.data[1] -
             matrix.data[0] * matrix.data[9] * matrix.data[15]) *
            det;
  data[2] = (-matrix.data[5] * matrix.data[2] +
             matrix.data[1] * matrix.data[6] * matrix.data[15]) *
            det;
  data[6] = (+matrix.data[4] * matrix.data[2] -
             matrix.data[0] * matrix.data[6] * matrix.data[15]) *
            det;
  data[10] = (-matrix.data[4] * matrix.data[1] +
...
void IPhysics::Matrix4::SetOrientationAndPos(const Quaternion& quaternion,
...
void IPhysics::Matrix4::Invert() { SetInverse(*this); }
...
IPhysics::Vector3 IPhysics::Matrix4::TransformInverse(
    const Vector3& vector3) const {
  Vector3 tmp = vector3;
  tmp.x = tmp.x - data[3];
  tmp.y = tmp.y - data[7];
  tmp.z = tmp.z -= data[11];
  return {tmp.x * data[0] + tmp.y * data[4] + tmp.z * data[8],
          tmp.x * data[1] + tmp.y * data[5] + tmp.z * data[9],
          tmp.x * data[2] + tmp.y * data[6] + tmp.z * data[10]};
}

IPhysics::Vector3 IPhysics::Matrix4::TransformDirection(
    const Vector3& vector3) const {
  return {vector3.x * data[0] + vector3.y * data[1] + vector3.z * data[2],
          vector3.x * data[4] + vector3.y * data[5] + vector3.z * data[6],
          vector3.x * data[8] + vector3.y * data[9] + vector3.z * data[10]};
}

IPhysics::Vector3 IPhysics::Matrix4::TransformInverseDirection(
    const Vector3& vector3) const {
  return {vector3.x * data[0] + vector3.y * data[4] + vector3.z * data[8],
          vector3.x * data[1] + vector3.y * data[5] + vector3.z * data[9],
          vector3.x * data[2] + vector3.y * data[6] + vector3.z * data[10]};
}
 ...
 */
IPhysics::real IPhysics::RandomStore::RandomReal(real lowerBound,
                                                 real upperbound) {
  std::uniform_real_distribution<real> doubleDistribution(lowerBound,
                                                          upperbound);
...
IPhysics::Vector3 IPhysics::RandomStore::RandomVector3(
    const Vector3& lowerBound, const Vector3& upperbound) {
  return {RandomReal(lowerBound.x, upperbound.x),
          RandomReal(lowerBound.y, upperbound.y),
          RandomReal(lowerBound.z, upperbound.z)};
}

/*
 * Local and world transforms
 */
IPhysics::Vector3 IPhysics::LocalWorldTransforms::LocalToWorld(
    const Vector3& local, const Matrix4& transform) {
  return transform.Transform(local);
}

IPhysics::Vector3 IPhysics::LocalWorldTransforms::WorldToLocal(
    const Vector3& world, const Matrix4& transform) {
  return transform.TransformInverse(world);
}

IPhysics::Vector3 IPhysics::LocalWorldTransforms::LocalToWorldDirection(
    const Vector3& local, const Matrix4& transform) {
  return transform.TransformDirection(local);
}

IPhysics::Vector3 IPhysics::LocalWorldTransforms::WorldToLocalDirection(
    const Vector3& world, const Matrix4& transform) {
 ...
 */
IPhysics::real IPhysics::RealSqrt(real value) { return std::sqrt(value); }

IPhysics::real IPhysics::RealPow(real value, real power) {
  return std::pow(value, power);
}

IPhysics::real IPhysics::RealAbs(real value) { return std::abs(value); }
