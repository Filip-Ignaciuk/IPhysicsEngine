...
IPhysics::RigidBody::RigidBody(const Vector3& originalPosition, const Quaternion& originalOrientation, const real& inverseMass, const real& linearDamping, const real& angularDamping, const Matrix3& inverseInertiaTensor) : m_position(originalPosition), m_orientation(originalOrientation), m_inverseMass(inverseMass), m_linearDamping(linearDamping), m_inverseInertiaTensor(inverseInertiaTensor){
...
void IPhysics::RigidBody::AddForceAtPoint(const Vector3& vector, const Vector3& point){
...
void IPhysics::RigidBody::AddForceAtBodyPoint(const Vector3& vector, const Vector3& point){
...
void IPhysics::RigidBody::SetMass(real mass){
    m_inverseMass = 1 / mass;
}

void IPhysics::RigidBody::SetIsAwake(bool isAwake){
    m_isAwake = isAwake;
}
...
void IPhysics::RigidBody::SetInverseInertiaTensor(const Matrix3& inertiaTensor){
...
// Queries
IPhysics::Vector3 IPhysics::RigidBody::GetPointInLocalSpace(const Vector3& point) const {
    return m_transformMatrix.TransformInverse(point);
}

IPhysics::Vector3 IPhysics::RigidBody::GetPointInWorldSpace(const Vector3& point) const {
...
void IPhysics::RigidBody::CalculateTransformMatrix(Matrix4& transformMatrix, const Vector3& position, const Quaternion& orientation){
...
void IPhysics::RigidBody::CalculateTransformInertiaTensor(Matrix3& iitWorld, const Quaternion& quaternion, const Matrix3& iitBody, const Matrix4& rotmat){
