...
IPhysics::BoundingSphere::BoundingSphere(const Vector3& _centre, real _radius) : m_centre(_centre), m_radius(_radius){

}

IPhysics::BoundingSphere::BoundingSphere(const BoundingSphere& _one, const BoundingSphere& _two){
...
bool IPhysics::BoundingSphere::Overlaps(const BoundingSphere* _other) const{
