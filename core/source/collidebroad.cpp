...
IPhysics::BoundingSphere::BoundingSphere(const Vector3& centre, real radius) : m_centre(centre), m_radius(radius){

}

IPhysics::BoundingSphere::BoundingSphere(const BoundingSphere& one, const BoundingSphere& two){
