...
// Constructors
IPhysics::Aero::Aero(const Matrix3& tensor, const Vector3& localPosition,
...
void IPhysics::Aero::UpdateForceFromTensor(RigidBody* body, real duration,
...
// Mutators
void IPhysics::AeroControl::SetControl(real value) { m_controlSetting = value; }
...
IPhysics::Matrix3 IPhysics::AeroControl::GetTensor() {
  if (m_controlSetting <= -1.0f) {
    ...
    return Matrix3::LinearInterpolate(m_minTensor, m_tensor,
