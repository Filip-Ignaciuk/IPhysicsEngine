...
IPhysics::real IPhysics::ParticleLink::CurrentLength() const {
  Vector3 relativePosition =
      particles[0]->GetPosition() - particles[1]->GetPosition();
  return relativePosition.Magnitude();
}

unsigned IPhysics::ParticleCable::AddContact(ParticleContact* contact,
...
unsigned IPhysics::ParticleRod::AddContact(ParticleContact* contact,
                                           unsigned limit) const {
