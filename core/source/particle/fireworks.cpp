...
IPhysics::FireworkRule::FireworkRule() : type(0), minAge(0), maxAge(0), minVelocity(Origin), maxVelocity(Origin), damping(0), payloadCount(0), payloads(nullptr){
...
IPhysics::real IPhysics::Firework::GetAge(){
    return m_age;
}
...
unsigned IPhysics::FireworkManager::GetMaxFireworks(){
    return maxFireworks;
}
