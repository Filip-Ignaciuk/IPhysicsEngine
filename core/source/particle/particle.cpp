...
namespace IPhysics {
IPhysics::Particle::Particle()
    : m_inverseMass(1.0f),
      m_damping(0.1f),
      m_acceleration(Origin),
      m_forceAccumulated(Origin),
      m_position(Origin),
      m_velocity(Origin) {}

IPhysics::Particle::Particle(Vector3 position, real damping, real inverseMass)
    : m_position(position), m_damping(damping), m_inverseMass(inverseMass) {}
...
void IPhysics::Particle::SetDamping(real damping) { m_damping = damping; }
...
void IPhysics::Particle::ClearAccumulator() { m_forceAccumulated.Clear(); }
...
Vector3 IPhysics::Particle::GetPosition() const { return m_position; }

Vector3 IPhysics::Particle::GetVelocity() const { return m_velocity; }

Vector3 IPhysics::Particle::GetAcceleration() const { return m_acceleration; }

real IPhysics::Particle::GetDamping() const { return m_damping; }

real IPhysics::Particle::GetInverseMass() const { return m_inverseMass; }

real IPhysics::Particle::GetMass() const { return 1 / m_inverseMass; }
