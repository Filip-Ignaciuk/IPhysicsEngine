...
bool IPhysicsEngine::IntersectionTests::OverlapOnAxis(const CollisionBox& _box1, const CollisionBox& _box2, const Vector3& _axis, const Vector3& _toCentre){
...
bool IPhysicsEngine::IntersectionTests::BoxAndBox(const CollisionBox& _box1, const CollisionBox& _box2){
...
unsigned IPhysicsEngine::CollisionDetector::BoxAndBox(const CollisionBox& _box1, const CollisionBox& _box2, CollisionData* _data){
    Vector3 toCentre = _box2.GetAxis(3) - _box1.GetAxis(3);
...
bool IPhysicsEngine::CollisionDetector::TryAxis(const CollisionBox& _box1, const CollisionBox& _box2, Vector3 _axis, const Vector3& _toCentre, unsigned _index, real& _smallestPenetration, unsigned& _smallestCase){
...
IPhysicsEngine::real IPhysicsEngine::CollisionDetector::PenetrationOnAxis(const CollisionBox& _box1, const CollisionBox& _box2, const Vector3& _axis, const Vector3& _toCentre){
...
void IPhysicsEngine::CollisionDetector::FillPointFaceBoxBox(const CollisionBox& _box1, const CollisionBox& _box2, const Vector3& _toCentre, CollisionData* _data, unsigned _best, real _penetration){
...
IPhysicsEngine::Vector3 IPhysicsEngine::CollisionDetector::ContactPoint(const Vector3& _pointOnOneEdge, const Vector3& _oneAxis, real _oneSize, const Vector3& _pointOnTwoEdge, const Vector3& _twoAxis, real _twoSize, bool _useOne){
