...
// GUI state
static bool showListObjectBox = false;
static bool showAddObjectBox = false;
static bool showAddMeshBox = false;
static bool showPreviewBox = false;
static bool showHelpBox = false;
static bool showSettingsBox = false;
...
static IPhysics::Vector3* position = new IPhysics::Vector3();
static IPhysics::Quaternion* orientation = new IPhysics::Quaternion();
static std::string* name = new std::string();
static IPhysics::real* mass = new IPhysics::real();
static IPhysics::real* linearDamping = new IPhysics::real();
static IPhysics::real* angularDamping = new IPhysics::real();
static IPhysics::Matrix3* inverseInertiaTensor = new IPhysics::Matrix3();
static Mesh* mesh;
static Color* color;
static IPhysics::real* scale;
