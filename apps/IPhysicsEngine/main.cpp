...
int main()
{
    ...
    IPhysics::ParticleGravity* particleGravity = new IPhysics::ParticleGravity(IPhysics::GravityEarth);
    IPhysics::Firework* firework = new IPhysics::Firework();
    IPhysics::FireworkManager* fireworkManager = new IPhysics::FireworkManager();
       

    particleWorld.GetParticleForceRegistry().Add(particle, particleGravity);
    IPhysics::ParticleGroundContactGenerator* particleGroundContactGenerator = new IPhysics::ParticleGroundContactGenerator();
    ...
    */
    ...
    while (!WindowShouldClose())
    {
        ...
        BeginDrawing();
            ...
            BeginMode3D(camera);
                /*
                IPhysics::ParticleWorld::Particles::iterator iterator = particleWorld.GetParticles().begin();
                ...
                */
                ...
                /*
                for (IPhysics::Firework* firework = fireworks; firework < fireworks + IPhysics::FireworkManager::GetMaxFireworks(); firework++){
