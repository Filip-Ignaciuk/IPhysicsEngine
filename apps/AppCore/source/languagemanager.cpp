...
// When launching an exe on apple it launches the exe within the user home
// directory.
const std::string IApp::LanguageManager::languagesDirectory =
    "Projects/IPhysicsEngine/build/resources/languages/";
#else
const std::string IApp::LanguageManager::languagesDirectory =
    "resources/languages/";
#endif
